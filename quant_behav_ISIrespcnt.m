...
function [resp_time, Pmax, Pmin, PmaxminR, resp_amp, pm_amp, resp_dir,tail_dir_s,resp, pm_amp_isi,resp_dir_isi, resp_isi, resp_amp_isi, resp_time_isi,resp_ISI_cnt,time_window] = quant_behav_ISIrespcnt(flicks,time,stim_size_degrees,ISI)
...
[pks_temp,locs_temp]=findpeaks(abs(tail_dir_s),'MinPeakDistance',5,'MinPeakHeight',15,'MinPeakProminence',10);
